...
enum eRectPointRelation
{
	RF_In = 0x00,	// �ھ�����
	RF_OutLeft = 0x01,	// �ھ������
	RF_OutRight = 0x02,	// �ھ����ұ�
	RF_OutTop = 0x04,	// �ھ����ϱ�
	RF_OutBottom = 0x08,	// �ھ����±�
	RF_OnLeft = 0x10,	// �ھ�����߽��ϣ������ӳ���
	RF_OnRight = 0x20, // �ھ����ұ߽���
	RF_OnTop = 0x40, // �ھ����ϱ߽���
	RF_OnBottom = 0x80, // �ھ����±߽���
};
...
int PointInRect(T x, T y, RCRect2_T r, double tolerance)
{
	...
	if (dis1 < dis2 && dis1 < tolerance)		 // ����߽���
		b |= RF_OnLeft;
	else if (dis1 > dis2 && dis2 < tolerance) // ���ұ߽���
		b |= RF_OnRight;
	else if (x < r.minx)						 // �����
		b |= RF_OutLeft;
	else if (x > r.maxx)					 // ���ұ�
	...
	if (dis1 < dis2 && dis1 < tolerance)		 // ���ϱ߽���
		b |= RF_OnTop;
	else if (dis1 > dis2 && dis2 < tolerance) // ���±߽���
		b |= RF_OnBottom;
	else if (y > r.maxy)					 // ���ϱ�
		b |= RF_OutBottom;
	else if (y < r.miny)						 // ���±�
...
public:
	...
	* �Ƿ��ھ��α߽��ϣ��������߽��ӳ��ߣ�����������
	* !!! �������Լ�ȷ�����ڶ�����
	* @param return : ���ڱ߽��Ϸ���0����߽緵��1���ұ߽緵��2���ϱ߽緵��3���±߽緵��4
	*/
	...
	/*
	* �����ڵľ��ζ������
	* @param return : û�ڶ�����Ϊ0�����ϽǶ���Ϊ1�����ϽǶ���Ϊ2�����½Ƕ���Ϊ3�����½Ƕ���Ϊ4
	*/
